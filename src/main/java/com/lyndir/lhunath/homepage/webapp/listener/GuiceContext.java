 ...
 */
package com.lyndir.lhunath.homepage.webapp.listener;
    ...
    protected Injector getInjector() {
        ...
        return Guice.createInjector( Stage.DEVELOPMENT, new ServletModule() {
            ...
            protected void configureServlets() {
                ...
                paramBuilder.put( ContextParamWebApplicationFactory.APP_CLASS_PARAM, HomepageWebApplication.class.getCanonicalName() );
