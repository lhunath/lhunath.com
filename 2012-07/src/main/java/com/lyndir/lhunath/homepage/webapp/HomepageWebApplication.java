...
import com.lyndir.lhunath.homepage.webapp.page.KidsPage;
...
/**
 * <h2>{@link HomepageWebApplication}<br> <sub>[in short] (TODO).</sub></h2>
 *
 * <p> <i>05 02, 2010</i> </p>
 *
 * @author lhunath
...
public class HomepageWebApplication extends WebApplication {
    ...
    protected void init() {
        ...
        mount( new HybridUrlCodingStrategy( "/kids", KidsPage.class ) );
